 ...
 */
static uint32_t lptim_select_prescaler(uint32_t clk_freq, uint32_t tick_hz, uint32_t *out_actual_hz)
{
    static const uint32_t divs[] = {1, 2, 4, 8, 16, 32, 64, 128};
    static const uint32_t consts[] = {LPTIM_PRESCALER_DIV1, LPTIM_PRESCALER_DIV2,
        LPTIM_PRESCALER_DIV4, LPTIM_PRESCALER_DIV8, LPTIM_PRESCALER_DIV16, LPTIM_PRESCALER_DIV32,
