...
bool ds18b20_read_scratch_pad(Ds18b20_t * ds, const uint8_t *device_address, uint8_t *scratch_pad);

// Write device's scratchpad
void ds18b20_write_scratch_pad(Ds18b20_t * ds, const uint8_t *device_address, const uint8_t *scratch_pad);
